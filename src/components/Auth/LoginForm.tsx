...
export const LoginForm: React.FC = () => {
  ...
  const demoCredentials = [
    { role: 'Customer', email: 'customer@transport.com', password: 'demo123' },
    { role: 'Driver', email: 'driver@transport.com', password: 'demo123' },
    { role: 'Admin', email: 'admin@transport.com', password: 'demo123' },
  ];
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Professional Transportation & Logistics Platform
          </p>
        </div>
