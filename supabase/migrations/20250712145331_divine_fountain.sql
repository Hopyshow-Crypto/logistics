-- LogiFlow Transportation & Logistics - Seed Data
...
('LF2024001006', 2, 3, 2, 1, 'express', 'delivered', 'normal', 'online', 'paid', 7.20, 180.00, 35.00, 19.80, 45.20, 6.78, 8.54, 115.32, 36.16, 180, '2024-01-20 11:00:00', '2024-01-20 11:12:00', '2024-01-20 14:00:00', 'Return shipment', 0, 0),
('LF2024001007', 4, NULL, 4, 3, 'standard', 'pending', 'normal', 'bank_transfer', 'pending', 22.50, 95.00, 25.00, 61.88, 28.50, 4.28, 9.57, 129.23, 22.80, 240, '2024-01-21 13:00:00', NULL, '2024-01-21 17:00:00', 'Heavy package - requires assistance', 0, 0),
('LF2024001008', 6, 5, 6, 5, 'economy', 'assigned', 'low', 'online', 'paid', 4.80, 60.00, 18.00, 13.20, 15.75, 2.36, 3.93, 53.24, 12.60, 300, '2024-01-22 09:00:00', NULL, '2024-01-22 15:00:00', 'Documents only', 0, 0);
...
(1, 'USB Cables', 'electronics', 5, 0.05, 10.00, 15.0, 2.0, 1.0, 'Accessories'),
(2, 'Office Supplies Box', 'package', 3, 4.10, 50.00, 40.0, 30.0, 20.0, 'Standard office items'),
(2, 'Printer Paper', 'package', 2, 2.50, 25.00, 30.0, 21.0, 5.0, 'Paper products'),
...
(5, 'Pharmaceutical Supplies', 'medical', 2, 1.50, 120.00, 20.0, 15.0, 10.0, 'Keep refrigerated'),
(6, 'Returned Electronics', 'electronics', 1, 2.20, 180.00, 35.0, 25.0, 8.0, 'Return merchandise'),
(7, 'Furniture Parts', 'furniture', 4, 5.63, 23.75, 80.0, 15.0, 10.0, 'Assembly hardware'),
(8, 'Contract Documents', 'document', 1, 0.30, 60.00, 32.0, 24.0, 3.0, 'Business documents');
...
(1, 'In Transit', 'Interstate 80, NJ', 40.7282, -74.0776, 'Package in transit to Los Angeles', 3, 'location', 1),
(1, 'Out for Delivery', 'Los Angeles, CA', 34.0522, -118.2437, 'Package out for final delivery', 3, 'status', 1),
(1, 'Delivered', '456 Broadway, Los Angeles, CA', 34.0522, -118.2437, 'Package delivered successfully - signed by Jane Doe', 3, 'status', 1),
...
(2, 'In Transit', 'Interstate 45, TX', 30.2672, -97.7431, 'En route to Houston', 5, 'location', 1),
...
(6, 'Booking Created', 'Los Angeles, CA', 34.0522, -118.2437, 'Return shipment created', 2, 'status', 1),
(6, 'Driver Assigned', 'Los Angeles, CA', 34.0522, -118.2437, 'Driver Mike Driver assigned for return', 1, 'status', 1),
(6, 'Package Picked Up', '456 Broadway, Los Angeles, CA', 34.0522, -118.2437, 'Return package collected', 3, 'status', 1),
(6, 'Delivered', '123 Main Street, New York, NY', 40.7589, -73.9851, 'Return package delivered successfully', 3, 'status', 1),
(7, 'Booking Created', 'Houston, TX', 29.7604, -95.3698, 'Heavy package delivery scheduled', 4, 'status', 1),
(8, 'Booking Created', 'Philadelphia, PA', 39.9526, -75.1652, 'Document delivery booking', 6, 'status', 1),
(8, 'Driver Assigned', 'Philadelphia, PA', 39.9526, -75.1652, 'Driver Robert Wilson assigned', 1, 'status', 1);
...
(6, 'debit_card', 'stripe', 'TXN_006_2024', 'pi_fedcba0987654321', 115.32, 'completed', '2024-01-20 10:30:00'),
(8, 'credit_card', 'stripe', 'TXN_008_2024', 'pi_1122334455667788', 53.24, 'completed', '2024-01-22 08:15:00');
...
(2, 1, 'delivery_completed', 'Package Delivered', 'Your package #LF2024001001 has been delivered successfully to 456 Broadway, Los Angeles, CA', 1, 'normal'),
(2, 6, 'delivery_completed', 'Return Package Delivered', 'Your return package #LF2024001006 has been delivered successfully', 0, 'normal'),
(4, 2, 'status_update', 'Package In Transit', 'Your package #LF2024001002 is currently in transit to Houston, TX', 0, 'normal'),
(6, 3, 'booking_created', 'Booking Confirmed', 'Your booking #LF2024001003 has been created and is pending driver assignment', 1, 'normal'),
(8, 4, 'pickup_scheduled', 'Pickup Scheduled', 'Your package #LF2024001004 is scheduled for pickup today at 4:00 PM', 0, 'high'),
(10, 5, 'driver_assigned', 'Driver Assigned', 'Driver James Martinez has been assigned to your same day delivery #LF2024001005', 0, 'normal'),
(3, NULL, 'system_alert', 'New Delivery Assignment', 'You have been assigned to delivery #LF2024001001', 1, 'normal'),
(5, NULL, 'system_alert', 'New Delivery Assignment', 'You have been assigned to delivery #LF2024001002', 1, 'normal'),
(7, NULL, 'system_alert', 'New Delivery Assignment', 'You have been assigned to delivery #LF2024001004', 0, 'high'),
(9, NULL, 'system_alert', 'New Delivery Assignment', 'You have been assigned to delivery #LF2024001005', 0, 'normal');

-- --------------------------------------------------------
-- Insert Driver Ratings
-- --------------------------------------------------------

INSERT INTO `driver_ratings` (`booking_id`, `driver_id`, `customer_id`, `rating`, `review`, `service_quality`, `punctuality`, `communication`, `professionalism`) VALUES
(1, 3, 2, 5, 'Excellent service! Package arrived on time and in perfect condition. Driver was very professional and courteous.', 5, 5, 5, 5),
(6, 3, 2, 5, 'Another great delivery by Mike. Always reliable and handles packages with care.', 5, 5, 4, 5);
